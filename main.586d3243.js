...
},{"buffer":"node_modules/buffer/index.js"}],"node_modules/keymage/keymage.js":[function(require,module,exports) {
var define;
...
},{}],"js/level-data.coffee":[function(require,module,exports) {
(function () {
  module.exports = [['⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ', '⛝                     ⛝ ', '⛝       ✠     ○       ⛝ ', '⛝         ✚ ✚ ◺       ⛝ ', '⛝       □ ■   ○       ⛝ ', '⛝                     ⛝ ', '⛝                     ⛝ ', '⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ '], ['⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ', '⛝ ⛝ ⛝       ◺ ◺       ⛝ ', '⛝ ⛝ ⛝       ⛝         ⛝ ', '⛝ ⛝ ⛝       ⛝ ⛝       ⛝ ', '✠       ◺ ◺ ○ ○       ⛝ ', '⛝ ⛝ ⛝       ⛝ ⛝       ⛝ ', '⛝ ⛝ ⛝       ⛝         ⛝ ', '⛝ ⛝ ⛝       ◺ ◺       ⛝ '], ['⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ', '⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ', '⛝           ◺   ✠       ', '⛝   ⛝ ⛝   ⛝ ⛝   ⛝ ⛝ ◺ ⛝ ', '⛝     ◺               ⛝ ', '⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ◺ ⛝ ', '⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ', '⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ '], ['⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ', '■   □   ◺   ◺         ⛝ ', '■   ✚   ○   ◺         ⛝ ', '■   ○   □ ✠ ◺         ⛝ ', '■   ◺   □   ◺   ✚     ⛝ ', '■   □   ○   ◺         ⛝ ', '■   ○   □   ◺         ⛝ ', '⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ '], ['  ■ ■   □ ■     ■       ', '  ■ ■   □ □     ■     ◺ ', '◺ ■ ■   ■ ■ ■   ⛝ ◺ ◺ ◺ ', '  ■ ■   ■ □ ■   ⛝ ◺   ◺ ', '  ■ ■   ■ ✠ ■ ○ ■       ', '◺ ■ ■   ■ ■ ■   ■       ', '  ■ ■   □       ■       ', '  ■ ■     ○     ■ ○ ○   '], ['✠                       ', '◺                   ✚   ', '◺     ◺       ◺ ◺       ', '  ⛝ ⛝ ◺ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝   ', '                        ', '  ⛝ ⛝ ⛝ ⛝   ⛝ ⛝   ⛝ ⛝ ⛝ ', '  ✚             ○ □ ■   ', '      ⛝ ⛝ ⛝ ⛝     ⛝ ⛝ ⛝ '], ['⛝ ⛝ ⛝ ⛝     ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ', '⛝ ⛝ ⛝ ■     □ ■   ⛝ ⛝ ⛝ ', '⛝ ⛝ ⛝ ⛝   ⛝ ○ ⛝   ⛝ ⛝ ⛝ ', '⛝ ⛝ ⛝ ◺ ✚ ✚ ✠ □ ◺ ■ ⛝ ⛝ ', '⛝ ⛝ ⛝ ⛝   ⛝ ◺ ⛝       ⛝ ', '⛝ ⛝ ⛝ ⛝     ○     ⛝   ⛝ ', '⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝   ⛝ ⛝   ⛝ ', '⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝         ⛝ '], ['⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ', '    ✚ ✚ ✚ ✚ ✚ □ ✚ ✚     ', '    ✚ ✚ ✚ ◺ ✚ ✚ ○ ✚     ', '✠   ✚ ✚ ✚ ◺ ✚ ✚ □ ✚     ', '    ✚ ✚ □ ○ ✚ ✚ ✚ ✚     ', '    ✚ ✚ ○ ◺ ✚ ✚ ✚ ✚     ', '    ✚ ✚ ◺ □ ✚ ✚ ✚ ✚     ', '⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ '], ['        ⛝ ⛝             ', '  ✚     ⛝ ⛝             ', '        ◺ □ □ ✚   ⛝ ⛝   ', '  ⛝     ◺ ⛝       ⛝ ⛝ ⛝ ', '      ◺ ◺ ✠ ⛝         ◺ ', '        ◺ ⛝     ⛝ ⛝ ⛝ ⛝ ', '  ✚ ⛝   ◺ ○ ○       ✚   ', '        □ ⛝             '], ['⛝ ⛝ ⛝ ⛝ ◺ ⛝ ⛝ ⛝         ', '⛝ ⛝ ⛝ ⛝   ⛝ ⛝ ⛝       ✠ ', '    □   ■ ■ ■       ✚   ', '  ✚ ✚   ■ ■ ■   □ ✚ □   ', '  ✚ ✚   ■ ■ ■   □ ✚ □   ', '        ■ ■ ■   ✚       ', '⛝ ⛝ ⛝ ⛝ ⛝   ⛝ ⛝         ', '⛝ ⛝ ⛝ ⛝ ⛝ ◺ ⛝ ⛝         '], ['⛝ ✠ ⛝   ⛝ ⛝ ■     ⛝ ⛝ ⛝ ', '⛝       ○ □ ■ ■   ◺ ◺   ', '⛝ ◺ ⛝ ◺   ⛝ ■     ◺ ◺   ', '⛝     ◺   ⛝       ✚ ✚   ', '⛝ ◺ ⛝     ⛝   ⛝   ✚ ✚   ', '          ⛝   ⛝ ⛝   ⛝   ', '  ✚ □ ✚   ⛝   ⛝         ', '        ◺ ◺ ◺ ⛝ ⛝ ⛝ ⛝ ⛝ '], ['✠           ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ', '⛝ ◺ ⛝ ◺ ⛝ ◺ ⛝ ⛝       ⛝ ', '            ⛝     ⛝   ⛝ ', '⛝ ◺ ⛝ ◺ ⛝ ◺ ⛝         ⛝ ', '            ⛝ ⛝ ○ ○ ■ ⛝ ', '⛝ ◺ ⛝ ◺ ⛝ ◺ ⛝ ⛝   ◺ ◺ ⛝ ', '                    ◺ ⛝ ', '⛝   ⛝ ⛝ ⛝ ⛝ ⛝ ⛝     ⛝ ⛝ '], ['⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ', '    □   ◺   ○   □     ■ ', '    ◺   ○   ◺   □     ■ ', '✠   ✚   □   ○   □     ■ ', '    ○   □   ◺   □     ■ ', '    □   ◺   ○   □     ■ ', '    ✚   ✚   ◺   □     ■ ', '⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ '], ['⛝ ⛝ ⛝ ⛝ ⛝     ⛝     ⛝ ⛝ ', '⛝ ⛝   ◺     □     ◺   ⛝ ', '⛝ ■     ○ ⛝   ⛝ ⛝     ⛝ ', '⛝ ⛝ ⛝     ✚ ○ ✚     ⛝ ⛝ ', '⛝ ⛝     ⛝ ⛝   ⛝ ○     ■ ', '⛝ ⛝   ◺     □       ✠ ⛝ ', '⛝ ⛝     ⛝     ⛝ ⛝ ⛝ ⛝ ⛝ ', '⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ ⛝ '], ['      ■   ■   ■   ■   ⛝ ', '      ■   ■   ■   ■   ⛝ ', '  ✚ □ ■   ■   ■   ■   ◺ ', '  □   ■   ■ □ ■   ■   ⛝ ', '  ✚   ■   ■   ■   ■   ⛝ ', '✠     ■ □ ■   ■   ■   ⛝ ', '    □ ■   ■   ■ □ ■   ⛝ ', '    □ ■   ■   ■   ■   ⛝ ']];
}).call(this);
},{}],"js/main.coffee":[function(require,module,exports) {
(function () {
  var _, jQuery, keymage;

  jQuery = require('jquery');
  _ = require('lodash');
  keymage = require('keymage');
  jQuery(function ($) {
    var $game, addHelpScreenHandlers, addLevelScreenHandlers, addTitleScreenHandlers, cacheElementAsProperty, changeMenuButton, changeScreen, constrainToRange, currentScreen, displayData, hideAllButOne, hideMessages, keys, levelGrid, levelStrings, menuButtons, messages, nativePixelsToDisplayPixels, registerKey, screens, selectInGame, showMenuButton, showMessage, showScreen, tiles; // game data
    ...
    screens = {
      ...
      level: {
        selector: ".level-screen"
      },
      finished: {
        selector: ".finished-screen"
      }
    };
    menuButtons = {
    ...
    messages = {
      allSelector: '.message',
      title: {
        selector: ".dont-match-message"
      },
      help: {
        selector: ".you-fell-message"
      },
      level: {
        selector: ".beat-level-message"
      }
    };
    ...
    selectInGame = function selectInGame(selector) {
      return $game.find(selector);
    };

    cacheElementAsProperty = function cacheElementAsProperty(item) {
      return item.element = selectInGame(item.selector);
    };

    _([screens, messages, menuButtons]).each(function (collection) {
      return _(collection).each(cacheElementAsProperty);
    });

    hideAllButOne = function hideAllButOne(scopeSelector, oneToShow) {
      selectInGame(scopeSelector).hide();
      return oneToShow.show();
    }; // display functions. These do not run events, only change the visuals.


    showScreen = function showScreen(screen) {
      return hideAllButOne(screens.allSelector, screen.element);
    };

    showMenuButton = function showMenuButton(menuButton) {
      return hideAllButOne(menuButtons.allSelector, menuButton.element);
    };

    showMessage = function showMessage(message) {
      return hideAllButOne(messages.allSelector, message.element);
    };

    hideMessages = function hideMessages() {
      return selectInGame(messages.allSelector).hide();
    };

    nativePixelsToDisplayPixels = function nativePixelsToDisplayPixels(nativePixels) {
      return nativePixels * displayData.scaleFactor;
    }; // game state


    currentScreen = void 0; // more functions

    changeScreen = function changeScreen(screen) {
      if (currentScreen != null) {
        if (typeof currentScreen.exitHandler === "function") {
      ...
      return typeof currentScreen.enterHandler === "function" ? currentScreen.enterHandler() : void 0;
    };

    changeMenuButton = function changeMenuButton(button) {
      showMenuButton(button);
      return screens.title.selectedButton = button;
    ...
    _(screens).each(function (screen) {
      ...
      screen.enterHandler = function () {};

      return screen.exitHandler = function () {};
    });
    ...
    addTitleScreenHandlers = function addTitleScreenHandlers(title) {
      var moveButtonSelection;

      moveButtonSelection = function moveButtonSelection(direction) {
        var currentIndex, newIndex, numButtons;
        ...
        return changeMenuButton(currentScreen.buttonsInOrder[newIndex]);
      };

      title.inputHandlers.left = function () {
        return moveButtonSelection(-1);
      };

      title.inputHandlers.right = function () {
        return moveButtonSelection(1);
      };

      title.inputHandlers.confirm = function () {
        switch (currentScreen.selectedButton) {
          case menuButtons.play:
            return changeScreen(screens.level);

          case menuButtons.help:
            return changeScreen(screens.help);

          case menuButtons.exit:
        }
      };

      title.inputHandlers.exit = function () {};

      return title.enterHandler = function () {
        title.selectedButton = menuButtons.play;
        return showMenuButton(menuButtons.play);
      };
    };

    addTitleScreenHandlers(screens.title);

    addHelpScreenHandlers = function addHelpScreenHandlers(help) {
      var _drawNextLine, initializeDrawing, returnToMenuOnInput, setCropHeight;

      returnToMenuOnInput = function returnToMenuOnInput() {
        if (!currentScreen.drawing) {
          return changeScreen(screens.title);
        }
      };

      setCropHeight = function setCropHeight(heightInNativePixels) {
        var actualHeight, cropArea;
        actualHeight = nativePixelsToDisplayPixels(heightInNativePixels);
        cropArea = $(help.cropSelector);
        return cropArea.height(actualHeight);
      };

      initializeDrawing = function initializeDrawing() {
        currentScreen.drawing = true;
        currentScreen.currentCropY = help.drawData.startY;
        setCropHeight(currentScreen.currentCropY);
        return setTimeout(_drawNextLine, currentScreen.drawData.secsBetweenDraws * 1000);
      };

      _drawNextLine = function drawNextLine() {
        var finished;
        ...
        if (finished) {
          return currentScreen.drawing = false;
        } else {
          return setTimeout(_drawNextLine, currentScreen.drawData.secsBetweenDraws * 1000);
        }
      };

      help.inputHandlers.confirm = function () {
        return returnToMenuOnInput();
      };

      help.inputHandlers.exit = function () {
        return returnToMenuOnInput();
      };

      return help.enterHandler = function () {
    ...
    addLevelScreenHandlers = function addLevelScreenHandlers(level) {
      var inputHandlers;
      inputHandlers = {
        normal: {},
        messageShowing: {}
      ...
      level.inputHandlers.confirm = function () {};

      level.inputHandlers.exit = function () {
        return changeScreen(screens.title);
      };

      level.enterHandler = function () {};

      return level.exitHandler = function () {};
    ...
    addLevelScreenHandlers(screens.level); // register input handlers
    ...
    registerKey = function registerKey(control, handler) {
      return keymage(control, handler, {
        preventDefault: true
      });
    };

    _(keys).each(function (controls, eventName) {
      var runInputHandlerIfExists;

      runInputHandlerIfExists = function runInputHandlerIfExists(event) {
        var ref;
        return (ref = currentScreen.inputHandlers) != null ? typeof ref[eventName] === "function" ? ref[eventName](event) : void 0 : void 0;
      };

      return _(controls).each(function (control) {
        return registerKey(control, runInputHandlerIfExists);
      });
    }); // start the game
...
},{"jquery":"node_modules/jquery/dist/jquery.js","lodash":"node_modules/lodash/lodash.js","keymage":"node_modules/keymage/keymage.js","./level-data":"js/level-data.coffee"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/main.coffee"], null)
//# sourceMappingURL=/main.586d3243.js.map